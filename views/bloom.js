...
const BLOOM_PILLARS = [
  ...
  // Flourish now renders its own tag-driven landing. The eight former hobby
  // cards are retired as navigation — their concepts survive as categories, and
  // their copy is source material for future project drafts.
  { key: "flourish", ic: "📖", name: "Flourish", sub: "Learn, create, and become her.",
