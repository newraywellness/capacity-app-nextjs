...
const CYCLE_PHASES = {
  menstrual: { key: "menstrual", emoji: "🌑", name: "Menstrual Phase", color: "#A8556B", soft: "rgba(168,85,107,0.15)", meaning: "Rest, restoration, reflection",
    ...
    feels: ["Lower energy, especially the first day or two", "A pull toward warmth and rest", "Cramping that usually eases after day 2", "Clearer thinking returning by day 3 or 4"],
    supportToday: ["Heat — it has evidence comparable to ibuprofen for cramps", "Iron-rich food if your periods are heavy", "Gentle movement, or none at all", "Let the heaviest day be a lighter day"],
    nurseNote: "Rest is not falling behind. Recovery is what makes the next three weeks possible — it isn\u2019t time taken away from them.",
  ...
  follicular: { key: "follicular", emoji: "🌱", name: "Follicular Phase", color: "#6E9E6B", soft: "rgba(110,158,107,0.14)", meaning: "Growth, rebuilding, increasing energy",
    ...
    feels: ["Energy building day by day", "More motivation and social appetite", "Skin often at its clearest", "Better recovery between workouts"],
    supportToday: ["Lift heavier if it feels good", "Prioritise protein", "Hydrate well", "Start something you\u2019ve been putting off"],
    nurseNote: "Energy naturally rises for many women in this phase, but your capacity still comes first. Your cycle is one piece of the picture \u2014 not the whole story.",
  ...
  ovulation: { key: "ovulation", emoji: "☀️", name: "Ovulation Phase", color: "#D8A94E", soft: "rgba(216,169,78,0.16)", meaning: "Connection, confidence, higher energy awareness",
    ...
    feels: ["Often the most confident few days", "Higher libido for many", "Clear, stretchy discharge", "Sometimes a one-sided twinge"],
    supportToday: ["A good window for anything social", "Warm up properly before anything explosive", "Hydrate more if you\u2019re training harder", "Enjoy it without treating it as your baseline"],
    nurseNote: "This is often a high point, and every phase is still you. Try not to set the bar here for all the others.",
  ...
  luteal: { key: "luteal", emoji: "🌙", name: "Luteal Phase", color: "#5E7FB0", soft: "rgba(94,127,176,0.14)", meaning: "Preparation, slowing down, increased support",
    ...
    feels: ["Energy tapering, especially in the final week", "Appetite genuinely increasing", "Sleep lighter or more broken", "Mood more reactive in the last few days"],
    supportToday: ["Eat more \u2014 your metabolic rate really does rise", "Protect sleep harder than usual", "Lower the intensity rather than skipping", "Drop optional commitments in the last week"],
    nurseNote: "Your needs changing is information, not failure. Under-eating in this phase is the most common cause of the out-of-control feeling women blame on willpower.",
