...
const HERO_SPRIGS = [
  { x: 14,  y: 300, k: "lavender", h: 118, s: 30, d: -3,  o: 0.55 },
  { x: 424, y: 322, k: "mint",     h: 96,  s: 26, d: -15, o: 0.5 },
  { x: 34,  y: 356, k: "rosemary", h: 78,  s: 28, d: -9,  o: 0.45 },
]
const HERO_BLOSSOM = [
  { x: 404, y: 214, r: 5.5, o: 0.4 },
  { x: 26,  y: 176, r: 4.5, o: 0.34 },
  { x: 418, y: 268, r: 4,   o: 0.3 },
]
...
export function HerbGarden({ mode, subtle }) {
  ...
  return (
    <div style={{ position: "absolute", left: 0, right: 0, bottom: 104, height: GH, pointerEvents: "none", overflow: "hidden",
      maskImage: "linear-gradient(180deg,rgba(0,0,0,0) 0%,rgba(0,0,0,0.6) 18%,rgba(0,0,0,1) 42%)",
      WebkitMaskImage: "linear-gradient(180deg,rgba(0,0,0,0) 0%,rgba(0,0,0,0.6) 18%,rgba(0,0,0,1) 42%)" }}>
      ...
      <div style={{ position: "absolute", inset: 0, opacity: o }}>
        <svg width="100%" height={GH} viewBox={`0 0 440 ${GH}`} preserveAspectRatio="xMidYMax slice" style={{ display: "block" }}>
          ...
          <rect x="0" y={GH - 210} width="440" height="210" fill="url(#tr-herbground)" />

          {/* citrus, mostly off-screen — little discoveries */}
          <g transform={`translate(-14,${GH - 22}) rotate(-13)`} opacity="0.95"><Slice kind="orange" c={c} size={48} /></g>
          <g transform={`translate(452,${GH - 30}) rotate(11)`} opacity="0.92"><Slice kind="lemon" c={c} size={44} /></g>
          <ellipse cx="46" cy={GH - 62} rx="13" ry="6" fill={c.basil} opacity={0.62 * S.citrusLeaf} transform={`rotate(-32 46 ${GH - 66})`} />
          <ellipse cx="416" cy={GH - 72} rx="11.5" ry="5.5" fill={c.basil} opacity={0.55 * S.citrusLeaf} transform={`rotate(28 416 ${GH - 76})`} />
